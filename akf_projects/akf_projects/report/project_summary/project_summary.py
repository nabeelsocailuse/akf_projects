...
def execute(filters=None):
	...
	for project in data:
		...
		project["pending_tasks"] = frappe.db.count(
...
def get_columns():
	return [
		...
		{"fieldname": "pending_tasks", "label": _("Tasks Pending"), "fieldtype": "Data", "width": 120},
...
def get_chart_data(data):
	...
	for project in data:
		...
		pending.append(project.pending_tasks)

	return {
		"data": {
			"labels": labels[:30],
			"datasets": [
				{"name": _("Pending"), "values": pending[:30]},
		...
		"type": "bar",
		"colors": ["#ffa500","#fc4f51", "#78d6ff", "#7575ff"],
...
def get_report_summary(data):
	...
	total_pending = sum([project.pending_tasks for project in data])
	...
	return [
		...
		{
			"value": total_pending,
			"indicator": "Green" if total_pending == 0 else "Red",
